        ...
        <div class="info-wrapper">
            ...
            <div class="info-section">
                <div class="title-wrapper">
                    <h1 class="card-movie-title">Brightffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff</h1>
                </div>
                ...
                <table class="card-movie-info">
                    ...
                    <tr class="row">
                        ...
                        <td class="row-value row-title-original">
                            fffffffff fggggg gggsssss ssssss ssssssss ssssss ssssssss sssggggg gfffffffffff fffff ffff fffff fffff fffff fff</td>
                    </tr>
                    <tr class="row">
                ...
                <div class="movie-social">
                    <ul class="social-icons">
                        ...
                        <li class="heart-box">
                            <svg id="heart" class="icon icon-heart" xmlns="http://www.w3.org/2000/svg"
